...
<section class="w-full mt-16 lg:mt-0 md:h-[90%] xl:h-[85%] overflow-hidden">
    <div>
        <div class="relative w-auto h-full lg:w-full swiper">
            ...
            <div class="h-full swiper-wrapper">
                ...
                <div class="relative w-auto lg:h-full lg:w-full swiper-slide">
                    ...
                    <div
                        ...
                        <a href="{{ $hero['button_link'] ? route($hero['button_link']) : '#' }}"
                            class="px-4 py-2 mt-6 text-sm text-white transition bg-green-900 lg:px-6 lg:py-3 lg:text-lg w-fit hover:bg-green-800">
                            {{ $hero['button_text'] }}
                        </a>
                        @endif
                    </div>
                    ...
                    @if ($banner_type === 'home')
                    <div class="absolute inset-0 z-20 bg-gradient-to-r from-white via-white/20 to-transparent">
                    </div>
            ...
            @if ($banner_type === 'home')
            <div
                class="absolute bottom-0 right-0 z-20 flex justify-between gap-2 {{ $heroes ? 'p-0' : 'p-5' }} bg-white">
                <div
