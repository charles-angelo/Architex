    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-20'"
        ...
        <div>
            ...
            <div class="flex items-center justify-between p-4 border-b border-white/20">
                <!-- Full Logo -->
                <img src="{{ asset('img/homepage/logo.png') }}" alt="Architex Logo" class="w-auto h-10"
                    x-show="sidebarOpen" x-transition>

                <!-- Small Logo -->
                <img src="{{ asset('img/homepage/logo.png') }}" alt="Small Logo" class="w-auto h-10 mx-auto"
                    x-show="!sidebarOpen" x-transition>

                <!-- Toggle Button -->
                <button class="transition text-white/70 hover:text-white" @click="sidebarOpen = !sidebarOpen">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 transition-transform duration-300 transform"
        ...
        {{ request()->routeIs('admin.blogs.*') || request()->routeIs('admin.blogCategories.*') ? 'bg-white text-[#1E4D2B] font-semibold' : '' }}"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span x-show="sidebarOpen" x-transition class="whitespace-nowrap">Content
                                    Management</span>
                            </div>
...
{{ request()->routeIs('admin.properties.*') || request()->routeIs('admin.blocks.*') || request()->routeIs('admin.lots.*') || request()->routeIs('admin.lotTypes.*') || request()->routeIs('admin.lotCategories.*') ? 'bg-white text-[#1E4D2B] font-semibold' : '' }}"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <!-- Text -->
                                <span x-show="sidebarOpen" x-transition class="whitespace-nowrap">Property
                                    Management</span>
                            </div>
        ...
        <form method="POST" action="{{ route('admin.logout') }}" class="p-4 border-t border-white/20">
            ...
            <button type="submit"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6A2.25 2.25
