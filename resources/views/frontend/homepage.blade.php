            ...
            <div class="space-y-10">
                @foreach ($properties as $property)
                    ...
                    <x-service-card title="Property for Sale"
                        ...
                        button-text="See All For Sale" :button-link="route('properties.for_sale', ['id' => $property->id])" image="img/homepage/sale.png" />
                    ...
                    <x-service-card title="Property for Rent"
                        ...
                        button-text="See All For Rent" :button-link="route('properties.for-rent', ['id' => $property->id])" image="img/homepage/rent.png" :reverse="true" />
                @endforeach
            </div>
        </div>
    </section>
        ...
        <div class="relative z-0 max-w-screen-xl mx-auto">
            ...
            <section class="bg-transparent pt-20 lg:pb-[10rem]">
                <div class="grid max-w-screen-xl grid-cols-1 gap-8 px-6 mx-auto xl:grid-cols-3">
                    ...
                    @empty
                        <p class="col-span-3 text-center text-gray-500">No blogs available yet.</p>
                    @endforelse
                </div>
            </section>
        </div>
